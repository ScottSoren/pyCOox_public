...
V_str, J_str = sync_metadata(data, RE_vs_RHE=0.715, A_el=0.196#*1e-3, J_str='J / [$\mu$A cm$^{-2}$]'
                             )
...
if True: # plot CO stripping experiment
    ...
    t_bg = [t-tspan_CO_strip[0] for t in t_bg_abs] # it should be relative to the start of the interval.
    ...
    axes1 = plot_experiment(data_strip, mols=[[CO, He], [H2, CO2_M44, CO2_M46, CO2_M48]],
                    removebackground='right', t_bg=t_bg, logplot=False,
                           spec={'linewidth':0.5})
    ...
    axes1[0].get_figure().set_figwidth(figwidth*1.1)  # to make room for right y-axis label
    ...
    axes2 = plot_vs_potential(data_strip, mols=[CO2_M44, CO2_M46, CO2_M48, H2],
                           logplot=False, t_bg=t_bg, tspan=tspan_c1,
                           spec={'linewidth':0.5})
    plot_vs_potential(data_strip, mols=[CO2_M44, CO2_M46, CO2_M48, H2],
                      ax=axes2, logplot=False, t_bg=t_bg, tspan=tspan_c2,
    ...
    axes2[0].get_figure().set_figwidth(figwidth*0.9) # to compensate for other panel's right y-axis label
...
if True: #plot bulk CO oxidation experiment
    ...
    t_bg = [t-tspan_CO_ox[0] for t in t_bg_abs] # it should be relative to the start of the interval.
    ...
    axes1 = plot_experiment(data_ox, mols=[[CO, He], [H2, CO2_M44, CO2_M46, CO2_M48, O2_M32, O2_M34, O2_M36]],
                    removebackground='right', t_bg=t_bg, logplot=False,
                           spec={'linewidth':0.5})
    ...
    tspan_c1 = [t-tspan_CO_ox[0] for t in tspan_c1_abs] # it should be relative to the start of the interval.
    tspan_c2 = [t-tspan_CO_ox[0] for t in tspan_c2_abs] # it should be relative to the start of the interval.

    axes2 = plot_vs_potential(data_ox, mols=[CO2_M44, CO2_M46, CO2_M48, H2, O2_M32, O2_M34, O2_M36],
                           logplot=False, t_bg=t_bg, tspan=tspan_c1,
                           spec={'linewidth':0.5})
    plot_vs_potential(data_ox, mols=[CO2_M44, CO2_M46, CO2_M48, H2, O2_M32, O2_M34, O2_M36],
                      ax=axes2, logplot=False, t_bg=t_bg, tspan=tspan_c2,
                      spec={'linestyle':'--', 'linewidth':0.5})
